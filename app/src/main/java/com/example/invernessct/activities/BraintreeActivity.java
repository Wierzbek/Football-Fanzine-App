...
public class BraintreeActivity extends AppCompatActivity {
    ...
    final String get_token = "http://kamilwierzbicki.com/braintreeApi/main.php";
    final String send_payment_details = "http://kamilwierzbicki.com/braintreeApi/checkout.php";
    String token, amount;
